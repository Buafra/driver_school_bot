...
# - No-school SUB-MENU (Today / Tomorrow / Pick Date)
...
def clamp_start_by_weekstart(data: Dict[str, Any], start_date: date) -> date:
    """
...
async def menu_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if is_admin(uid):
        keyboard = [
            ...
            [KeyboardButton(BTN_NOSCHOOL_MENU), KeyboardButton(BTN_EXPORT)],
